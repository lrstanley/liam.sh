...
func (ec *executionContext) _GithubEvent_repo(ctx context.Context, field graphql.CollectedField, obj *ent.GithubEvent) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNGithubEventRepo2ᚖgithubᚗcomᚋgoogleᚋgoᚑgithubᚋv44ᚋgithubᚐRepository(ctx, field.Selections, res)
}
...
func (ec *executionContext) _GithubRepository_license(ctx context.Context, field graphql.CollectedField, obj *ent.GithubRepository) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOGithubLicense2ᚖgithubᚗcomᚋgoogleᚋgoᚑgithubᚋv44ᚋgithubᚐLicense(ctx, field.Selections, res)
}
...
func (ec *executionContext) _GithubUser_createdAt(ctx context.Context, field graphql.CollectedField, obj *github.User) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOTimestamp2ᚖgithubᚗcomᚋgoogleᚋgoᚑgithubᚋv44ᚋgithubᚐTimestamp(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputCreatePostInput(ctx context.Context, obj interface{}) (ent.CreatePostInput, error) {
	...
	fieldsInOrder := [...]string{"slug", "title", "content", "publishedAt", "labelIDs"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputUpdatePostInput(ctx context.Context, obj interface{}) (ent.UpdatePostInput, error) {
	...
	fieldsInOrder := [...]string{"slug", "title", "content", "publishedAt", "addLabelIDs", "removeLabelIDs"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) marshalNGithubEventRepo2ᚖgithubᚗcomᚋgoogleᚋgoᚑgithubᚋv44ᚋgithubᚐRepository(ctx context.Context, sel ast.SelectionSet, v *github.Repository) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOGithubLicense2ᚖgithubᚗcomᚋgoogleᚋgoᚑgithubᚋv44ᚋgithubᚐLicense(ctx context.Context, sel ast.SelectionSet, v *github.License) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
...
func (ec *executionContext) marshalOTimestamp2ᚖgithubᚗcomᚋgoogleᚋgoᚑgithubᚋv44ᚋgithubᚐTimestamp(ctx context.Context, sel ast.SelectionSet, v *github.Timestamp) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
