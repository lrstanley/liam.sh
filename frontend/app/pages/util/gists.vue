    ...
    <div class="relative overflow-x-hidden size-full grow basis-0">
      <motion as="div" :initial="{ opacity: 0 }" :animate="{ opacity: 1 }" :exit="{ opacity: 0 }"
        ...
        <div class="flex items-center gap-2 truncate grow">
          ...
          <a target="_blank" class="text-primary" :href="'/-/gh/g/' + gist.name">[open]</a>
          <a target="_blank" class="text-primary" :href="gist.html_url">[gh]</a>
          <a target="_blank" class="text-warning hover:text-warning-600" :href="gist.raw_url">
            [raw]
          </a>
