...
const { data: githubStats } = await useApi('/stats/github')
...
<template>
  <UPopover v-if="githubStats && gh" :mode="small ? 'click' : 'hover'" :open-delay="100"
    :content="{ side: 'top', align: 'end', sideOffset: 0 }" v-bind="$attrs">
    <div class="px-2 text-highlighted transition hover:text-current inline-flex items-center cursor-pointer">
      ...
      <div class="p-1">
        ...
        <div class="mt-4">
          <div class="flex flex-row justify-between flex-auto mt-1">
            <span>
              <UIcon name="mdi:source-commit" class="text-muted" />
              Total Commits ({{ year }})
            </span>
          ...
          <div class="flex flex-row justify-between flex-auto mt-1">
            <span>
              <UIcon name="mdi:heart-multiple-outline" class="text-muted" />
              Contributed To ({{ year }})
            </span>
            <UBadge class="ml-1" color="primary" variant="soft">
          ...
          <div class="flex flex-row justify-between flex-auto mt-1">
            <span>
              <UIcon name="mdi:star-check-outline" class="text-muted" />
              Total Stars Earned
            </span>
            <UBadge class="ml-1" color="primary" variant="soft">
          ...
          <div class="flex flex-row justify-between flex-auto mt-1">
            <span>
              <UIcon name="mdi:source-pull" class="text-muted" />
              Total PRs
            </span>
            <UBadge class="ml-1" color="primary" variant="soft">
          ...
          <div class="flex flex-row justify-between flex-auto mt-1">
            <span>
              <UIcon name="mdi:help-circle-outline" class="text-muted" />
              Total Issues
            </span>
            <UBadge class="ml-1" color="primary" variant="soft">
